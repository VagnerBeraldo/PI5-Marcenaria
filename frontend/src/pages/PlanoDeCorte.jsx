...
//     setChapas([...chapas, { id: novoId, largura: 2750, altura: 1840 }]);
...
//     try {
//       const payload = {
//         // Envia o ID se já existir, senão envia null para o backend criar
...
//       // Agora o sistema sabe que este projeto tem um ID de Orçamento oficial
//       atualizarContexto({ 
...
//     setIsLoading(true);
//     try {
//       // PRIMEIRO: Verifica se existem orçamentos no banco de dados (A TRAVA)
...
//       // SEGUNDO: Busca os planos de corte existentes
...
//                 atualizarContexto({ nomeProjetoGlobal: plano.nome_servico, planoCorte: plano });
//                 Swal.close();
//               };
//             });
//           };
...
//   const chapaAtual = chapas.find((c) => c.id === chapaAtivaId) || { id: 1, largura: 2750, altura: 1840 };
...
//     setChapas((prev) => prev.map((c) => c.id === chapaAtivaId ? { ...c, [campo]: Number(valor) } : c));
//   };
...
//     setPecas([]);
//     setChapaAtivaId(1);
//     atualizarContexto({ nomeProjetoGlobal: "", planoCorte: null });
//   };
